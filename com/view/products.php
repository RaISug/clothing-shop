                	...
                	<div class="col-md-4">
                  		<div class="card mb-4 shadow-sm">
                  			<a href="<?php echo $response->serverContext(); ?>/products/api/v1/product/<?php echo $product->id(); ?>">
                        		<img class="card-img-top" style="max-height: 350px; min-height: 350px;" src="<?php echo $response->imagesContext(); ?>/<?php echo $product->getFirstImageName(); ?>" alt="Card image cap">
                  			</a>
