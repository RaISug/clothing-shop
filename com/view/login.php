...
?>
	...
	<div class="container" style="margin-top: 25px; margin-bottom: 25px;">
		...
		<?php 
    		if ($request->getQueryParameter("login") === "required") {
		    ?>
    		    <div class="alert alert-success" role="alert">
                	<?php echo $internationalizationService->get("login_view_login_required_message"); ?>
                </div>
		    <?php
    		}
		?>
		...
		<form action="<?php echo $response->serverContext(); ?>/login" method="POST">
			<div class="form-group row">
				<label class="form-label col-sm-3" for="username">
					<?php echo $internationalizationService->get("login_view_username"); ?>
				</label>
			...
			<div class="form-group row">
				<label class="form-label col-sm-3" for="password">
					<?php echo $internationalizationService->get("login_view_password"); ?>
				</label>
			...
			<div>
				<button type="submit" class="btn btn-primary col-sm-6 offset-sm-3">
					<?php echo $internationalizationService->get("login_view_login_button"); ?>
				</button>
			</div>
		</form>
